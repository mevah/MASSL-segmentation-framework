...
def BraTS18data(data_seed, data_split):
    ...
    # Create image list
    HGG_imgList = sorted(glob('/scratch_net/pengyou/himeva/data/MRBrains18/img_*.npy'))
    HGG_maskList = sorted(glob('/scratch_net/pengyou/himeva/data/MRBrains18/mask_*.npy'))
